...
const PLANS: PlanCard[] = [
  {
    ...
    features: [
      ...
      'JSON export',
      '3 templates',
      'ForgeAI: 3 generations/month (15s)',
    ],
  },
  {
    tier: 'pro',
    ...
    features: [
      ...
      'Drum sequencer',
      'Full chord library & templates',
      'Sound packs',
      'ForgeAI: 50 generations/month (2 min)',
      'AI stem separation',
    ],
  },
  {
    ...
    features: [
      'Everything in Pro',
      'ForgeAI: Unlimited generations (5 min)',
      'AI stem separation & full-song mode',
